...
@Component({
  ...
  templateUrl: './register-filiador-apoio.page.html',
          ...
          async loadLider(){
            ...
            loader.present();
              ...
              return new Promise(resolve => {
                ...
                id_filiador: this.id_filiador_apoio,
                start: this.start,
                limit: this.limit
            ...
            async loadMunicipio(){
              ...
              return new Promise(resolve => {
                let body={
                aksi: 'proses_consulta_municipio',
                id_filiador: this.id_filiador_apoio,
                ...
                this.accsPrvdrs.postData(body,'proses_api.php').subscribe((res:any)=>{
                      this.id_municipio = res.result[0].id_municipio;
                       this.a = res.result[0].id_municipio;
                       this.loadZona(this.a);
                      console.log('d',this.id_municipio = res.result[0].id_municipio )
                },(err)=>{
