...
@Component({
  ...
  templateUrl: './modal-lideranca-pendente.page.html',
  styleUrls: ['./modal-lideranca-pendente.page.scss'],
})
export class ModalLiderancaPendentePage implements OnInit {
  ...
  ionViewDidEnter(){
   ...
   async loadUsers(){
      ...
      return new Promise(resolve => {
        let body={
        aksi: 'proses_consulta_all_pendentes',
        start: this.start,
        limit: this.limit
