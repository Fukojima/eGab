...
@Component({
  selector: 'app-consulta-filiador',
  templateUrl: './consulta-filiador.page.html',
  styleUrls: ['./consulta-filiador.page.scss'],
})
export class ConsultaFiliadorPage implements OnInit {
