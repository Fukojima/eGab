  ...
  async perfilImg(){
    const image = await Camera.getPhoto({
      ...
      source:CameraSource.Camera
          ...
          this.documento_perfil= image.base64String;
  
         this.enviadof = "displayedv"
